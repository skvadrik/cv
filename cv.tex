...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor's Degree in Mathematics and Systems Programming}{September 2008 -- June 2013}
      \resumeItemListStart
        \resumeItem{Faculty}{Applied Mathematics and Informatics}
        \resumeItem{Sub-faculty}{Discrete Mathematics and Algorithmics}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Research}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingShort{Tagged Deterministic Finite Automata with Lookahead}{February 2015 - August 2017}
